...
from packages.jhehemann.skills.documents_manager_abci.graph_tooling.queries.conditional_tokens import (
    user_positions as user_positions_query,
)
from packages.jhehemann.skills.documents_manager_abci.graph_tooling.queries.network import (
    block_number,
)
...
from packages.jhehemann.skills.documents_manager_abci.rounds import SynchronizedData
...
class QueryingBehaviour(BaseBehaviour, ABC):
    ...
    def _fetch_queries(self) -> Generator[None, None, Optional[list]]:
        ...
        queries = yield from self._handle_response(
